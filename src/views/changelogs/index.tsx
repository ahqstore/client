  ...
  return <>
    ...
    >
      <div className="readd flex flex-col space-y-2">
        <div>
          <h1>UI Redesign</h1>
          <span>We're experimenting with the Sidebar using a design language similar to <strong>"WinUI 3"</strong></span>
          <span>We're slowly starting to build the pages, starting with this one!</span>
        </div>
      </div>
    </Category>
